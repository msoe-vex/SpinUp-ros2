...
void RobotDefault::initialize() {
    ...
    left_drive_2 = new MotorNode(node_manager, 2, "leftDrive2", false); 
    left_drive_3 = new MotorNode(node_manager, 3, "leftDrive3", false); 
    left_drive_4 = new MotorNode(node_manager, 4, "LeftDrive4", false);
    
    right_drive_1 = new MotorNode(node_manager, 5, "rightDrive1", true); 
    right_drive_2 = new MotorNode(node_manager, 6, "rightDrive2", true);  
    right_drive_3 = new MotorNode(node_manager, 7, "rightRearDrive", true); 
    right_drive_4 = new MotorNode(node_manager, 8, "rightRearTopDrive", true); 
    ...
    intake_motor = new MotorNode(node_manager, 9, "intake", false);
    indexer_motor = new MotorNode(node_manager, 10, "indexer", false);
...
void RobotDefault::disabled() {}

void RobotDefault::competition_initialize() {}

void RobotDefault::autonomous() {}

// Must put all telepPeriodic() method from each class into here
void RobotDefault::opcontrol() {
    while (true) {
